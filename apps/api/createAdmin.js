        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    console.log("User ".concat(email, " already exists. Promoting to Global Admin..."));
                ...
                case 2:
                    ...
                    return [3 /*break*/, 5];
                case 3:
                    console.log("User ".concat(email, " not found. Creating new Global Admin..."));
                ...
                case 4:
                    tenant = _a.sent();
                    console.log("Success! Created Tenant ID: ".concat(tenant.id, " and Global Admin ").concat(email, ". Default Password: adminpassword123"));
                    _a.label = 5;
